...
Wanneer er een uitgebreide literatuurstudie is uitgevoerd, zal een proof of concept op gesteld worden. Hierin wordt de software die gevonden is op de proef gesteld. Hier wordt gekeken hoe correct de ASR's inkomende audio kunnen transcriberen. Daarnaast zal ook getest worden of er aan de hand van kernwoorden een juist fragment kan gekozen worden. Door de AI verschillende prompts te geven en te kijken of hij naar de juiste tijdsaanduiding in de video gaat. Nadat de poc afgewerkt is, wordt deze beoordeelt om te kijken hoe het in de context van het Zorglab toegepast kan worden.
...
Uit deze bachelorproef word verwacht dat er een proof of concept opgesteld wordt. Hierin zal gekeken worden of het haalbaar is om aan de hand van spraakherkenning en natuurlijke taalverwerking software een slecht nieuws gesprek oefening, in het zorglab, vlotter te doen verlopen. Zo kunnen ze kiezen of ze dit idee effectief in het lab willen toevoegen. Dit kan dan aan de hand van software samen met een  dat in het PoC is gebruikt. Anderzijds kunnen ze op basis ervan andere software met hetzelfde doeleinde inzetten.
